...
interface LogoProps {
  ...
  /**
   * Whether to show the text "RXAI" alongside the logo
   * @default true
   */
  showText?: boolean;
 ...
 */
const RXAILogo: React.FC<LogoProps> = ({ 
  className = '',
  size = 'md',
  variant = 'default',
  showText = true,
  ...
  // Animation classes if the logo is animated
  ...
  return (
    <div className={`flex items-center ${className}`}>
      <svg
        className={`${selectedSize} ${animationClasses}`}
        viewBox="0 0 64 64"
        fill="none"
