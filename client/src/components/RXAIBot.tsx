            ...
            <div className="bg-[#3B5B9D] text-white p-4 flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <span className="text-xs text-[#00D1D1] font-inter">Powered by RXAI</span>
                </div>
              </div>
                  ...
                  <div className="bg-white p-3 rounded-lg rounded-tl-none max-w-[80%] shadow-sm">
                    {isTyping ? (
                      ...
                      <p className="text-gray-800 font-lato">
                        Hi there! I'm your RXAI Tech Assistant, powered by RXAI. How can I help you with your web development needs today?
                      </p>
                    ) : null}
                  </div>
                </div>
