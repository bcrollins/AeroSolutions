      ...
      <Switch>
        ...
        <Route path="/member-dashboard">
          {() => (
            <>
              <Helmet>
                <title>Member Dashboard | ROLLINSX</title>
                <meta name="description" content="Access exclusive courses, forum discussions, and premium resources in your ROLLINSX member dashboard." />
